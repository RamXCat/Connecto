...
| **🔄 Auto-Startup** | Integrates with Windows Registry to silently launch on boot with a smart delay for network readiness. |
| **🛡️ Single-Instance Lock** | Intelligently prevents duplicate processes. Attempting to launch again wakes the existing app! |
